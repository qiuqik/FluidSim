...
namespace Seb.Fluid.Rendering
{
	public class FluidRenderTest : MonoBehaviour
	{
		...
		void Init()
		{
            ...
            // 将纹理传递给 Shader
            Shader.SetGlobalTexture("_TextureMap", textureMap);
            Shader.SetGlobalFloat("_TextureScale", textureScale);
			...
			void InitTextures()
			{
				...
				//GraphicsFormat fmtRGBA = GraphicsFormat.R16G16B16A16_SFloat;
